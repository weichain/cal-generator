  ...
  const file = ts.factory.updateSourceFile(
    ...
    [
      ...
      ts.factory.createClassDeclaration(
        ...
        ts.factory.createIdentifier(`${chain}SwapProvider`),
        undefined,
        [
        ...
        [
          ts.factory.createPropertyDeclaration(
            undefined,
            undefined,
            ts.factory.createIdentifier("doesBlockScan"),
            undefined,
          ...
          ts.factory.createMethodDeclaration(
            ...
            undefined,
            undefined,
            ts.factory.createIdentifier("generateSecret"),
            undefined,
            undefined,
            [
              ts.factory.createParameterDeclaration(
          ...
          ts.factory.createMethodDeclaration(
            ...
            undefined,
            undefined,
            ts.factory.createIdentifier("getSwapSecret"),
            undefined,
            undefined,
            [
              ts.factory.createParameterDeclaration(
                ...
                undefined,
                undefined,
                ts.factory.createIdentifier("claimTxHash"),
                undefined,
                ts.factory.createKeywordTypeNode(ts.SyntaxKind.StringKeyword),
                undefined
              ),
          ...
          ts.factory.createMethodDeclaration(
            ...
            undefined,
            undefined,
            ts.factory.createIdentifier("initiateSwap"),
            undefined,
            undefined,
            [
              ts.factory.createParameterDeclaration(
          ...
          ts.factory.createMethodDeclaration(
            ...
            undefined,
            undefined,
            ts.factory.createIdentifier("fundSwap"),
            undefined,
            undefined,
            [
              ts.factory.createParameterDeclaration(
          ...
          ts.factory.createMethodDeclaration(
            ...
            undefined,
            undefined,
            ts.factory.createIdentifier("verifyInitiateSwapTransaction"),
            undefined,
            undefined,
            [
              ts.factory.createParameterDeclaration(
          ...
          ts.factory.createMethodDeclaration(
            ...
            undefined,
            undefined,
            ts.factory.createIdentifier("claimSwap"),
            undefined,
            undefined,
            [
              ts.factory.createParameterDeclaration(
              ...
              ts.factory.createParameterDeclaration(
                ...
                undefined,
                undefined,
                ts.factory.createIdentifier("secret"),
                undefined,
                ts.factory.createKeywordTypeNode(ts.SyntaxKind.StringKeyword),
                undefined
              ),
          ...
          ts.factory.createMethodDeclaration(
            ...
            undefined,
            undefined,
            ts.factory.createIdentifier("refundSwap"),
            undefined,
            undefined,
            [
              ts.factory.createParameterDeclaration(
...
export default (chain: string, version: string): NetworkTemplate => {
  return {
    ...
    index: IndexTs(`${firstLetterToUpperCase(chain)}SwapProvider`),
    pkg: PackageJson(
      `@liquality/${firstLetterToLowerCase(chain)}-swap-provider`,
      version,
      dependencies(version),
      `Swap Provider implementation for ${firstLetterToUpperCase(chain)}`
    ),
    folder: `${firstLetterToLowerCase(chain)}-swap-provider`,
    fileName: `${firstLetterToUpperCase(chain)}SwapProvider.ts`,
  };
};
